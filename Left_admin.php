...
<div id="content">
  <div id="left">
    ...
    <ul id="submenu_3" class="dis">
      <li class="left_link" onClick="DoLocation(this)"><a href="stu_Update.php?action=yep" target="mainFrame"> 学生个人信息修改</a></li>
    </ul>
	...
	<li class="left_link" onClick="DoLocation(this)"><a href="logQuery.php?action=log"  target="mainFrame"> 离校学生查询</a></li>
    </ul>
  </div>
</div>
</body>
